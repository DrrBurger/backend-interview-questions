...
У практических задач рядом с вопросом будет стоять сложность ( <kbd style="background-color: #f2f2f2; color: #000;">easy-peasy</kbd> <kbd>medium</kbd> <kbd>hard</kbd> )
...
- <details>
  ...
  - Вопрос №1: [ Что выведет код? (Инициализация и добавление элементов) ]
  ...
  - Вопрос №2: [ Что выведет код? (Поиск в карте) ]
  ...
  - Вопрос №3: [ Что выведет код? (Удаление элемента) ]
  ...
  - Вопрос №4: [ Что выведет код? (Изменение значения по ключу) ]
  ...
  - Вопрос №5: [ Что выведет код? (Ключи с нулевыми значениями) ]
