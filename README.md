...
В данном Readme собраны вопросы на общие темы и непосредственно по языку GO, а так же ответы к ним. Вопросы сгрупированы по темам.
...
---
![Logo]([https://example.com/logo.png](https://github.com/DrrBurger/Photos_for_git/blob/master/1_3UreHEOa70zgNwE3JeFoHQ.webp))
